      ...
      <div className=" md:py-20 py-10 lg:py-24 lg:mx-16 mx-8 grid lg:grid-cols-1 grid-cols-1 gap-5">
        <div className="sm:max-w-xs lg:max-w-xl text-left md:ml-8 lg:order-1 order-2   lg:mt-0">
          ...
          <p
            ...
            style={{ lineHeight: "120%",color:"white" }}>
            First ever one stop high quality media resource  solution at your doorstap .
          </p>
          
          <div className='flex items-center mt-2 font-bold'>
          < FaPhoneVolume  className="lg:text-2xl text-[20px] " style={{  color:"white" }}/>
          <span className="lg:text-2xl text-[20px] "style={{ color:"white" }} > Call Now: 01619848555</span>
        </div>
          ...
          >
            <Link
              ...
              to="/"  
            >
              <span className="text-sm font-medium"> Get your dream</span>
