    ...
    >
      <div class="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
        ...
        <div class="hidden lg:mt-8 lg:flex lg:gap-4">
          <button
            class="prev-button rounded-full border border-white-600 p-3 text-white hover:bg-[#92468E] hover:text-white"
          >
          ...
          <button
            class="next-button rounded-full border border-white-600 p-3 text-white hover:bg-[#92468E] hover:text-white"
          >
        ...
        <div class="swiper-container !overflow-hidden">
          <div class="swiper-wrapper">
            <div class="swiper-slide bg-gradient-to-r from-[#38235D] to-[#ab4059]" >
              <blockquote
                class="flex h-full flex-col justify-between   p-12"
              >
                <div>
